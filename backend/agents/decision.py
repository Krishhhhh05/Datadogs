...
class LaunchDecisionAgent(BaseAgent):
    ...
    def analyze(self, product_context: str, all_phase_data: Dict[str, Any], agent_info: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "  \"decision\": \"GO\",\n"
            "  \"confidence_score\": 82,\n"
            "  \"reasoning_summary\": \"Strong market validation and clear path to revenue, provided churn is managed.\",\n"
            "  \"critical_contingencies\": [\n"
            "    \"Must secure API partnerships before launch.\",\n"
            "    \"Keep CAC under $150 to maintain margin efficiency.\"\n"
            "  ],\n"
            "  \"weighted_sentiment\": {\n"
            "    \"Validation\": 8.5,\n"
            "    \"Financial\": 7.2,\n"
