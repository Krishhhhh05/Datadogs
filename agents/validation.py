...
class MarketAgent(BaseAgent):
    ...
    def analyze(self, product_context: str) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "  \"market_conditions\": [\n"
            "    {\"trend\": \"AI Automation\", \"growth_rate\": \"High\", \"analysis\": \"Explosive growth in B2B sector.\"}\n"
            "  ],\n"
            "  \"market_size\": [\n"
            "    {\"label\": \"TAM\", \"value\": 10000000000},\n"
            "    {\"label\": \"SAM\", \"value\": 2000000000},\n"
            "    {\"label\": \"SOM\", \"value\": 50000000}\n"
            "  ]\n"
            "}"
        )
...
class CustomerAgent(BaseAgent):
    ...
    def analyze(self, product_context: str) -> Dict[str, Any]:
        system_prompt = (
            ...
            "EXAMPLE OUTPUT FORMAT:\n"
            "{\n"
            "  \"perceived_value_score\": 90,\n"
            "  \"personas\": [\n"
            "    {\n"
            "      \"name\": \"Sarah\",\n"
            "      \"persona_type\": \"Decision Maker\",\n"
            "      \"demographics\": {\"age\": \"35-45\", \"income\": \"$120k+\", \"occupation\": \"VP of Sales\"},\n"
...
class CompetitiveAgent(BaseAgent):
    ...
    def analyze(self, product_context: str) -> Dict[str, Any]:
        ...
        system_prompt = (
            ...
            "CRITICAL: Output an array under the key `competitor_scores` containing objects with `name` (competitor name), `price_score`, `features_score`, `usability_score`, `brand_score`, and `innovation_score` (all 1-10). Include an object for the proposed product (`name`: 'Proposed Product').\n\n"
            "EXAMPLE OUTPUT FORMAT:\n"
            "{\n"
            "  \"competitor_scores\": [\n"
            "    {\"name\": \"Proposed Product\", \"price_score\": 9, \"features_score\": 8, \"usability_score\": 9, \"brand_score\": 2, \"innovation_score\": 9},\n"
            "    {\"name\": \"Incumbent Corp\", \"price_score\": 4, \"features_score\": 9, \"usability_score\": 5, \"brand_score\": 10, \"innovation_score\": 4}\n"
            "  ],\n"
            "  \"competitive_analysis\": [\n"
            "    {\n"
            "      \"name\": \"Incumbent Corp\",\n"
            "      \"description\": \"Legacy player with huge market share.\",\n"
