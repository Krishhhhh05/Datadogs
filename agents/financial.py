...
class RiskAgent(BaseAgent):
    ...
    def analyze(self, product_context: str, financial_context: Dict[str, Any]) -> Dict[str, Any]:
        system_prompt = (
            ...
            "CRITICAL: The `mitigation_strategy` field MUST be a highly detailed, comprehensive General Strategy written in markdown format (using headers, bullet points, and bold text). It should be at least 2-3 paragraphs long.\n"
            ...
            "  \"mitigation_strategy\": \"### Primary Strategy\\nOur overarching approach involves a staged rollout with pilot programs...\",\n"
            "  \"risk_matrix\": [\n"
